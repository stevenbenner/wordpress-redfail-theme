...
{
	echo '<link rel="stylesheet" type="text/css" href="'.versioned_resource($relative_url).'" '.$add_attributes.'/>'."\n";
}

// Add ?v=[last modified time] to javascripts
function versioned_javascript($relative_url, $add_attributes = '')
{
	echo '<script type="text/javascript" src="'.versioned_resource($relative_url).'" '.$add_attributes.'></script>'."\n";
}
